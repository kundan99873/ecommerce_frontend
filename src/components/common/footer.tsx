...
const Footer = () => {
  ...
  return (
    <footer className="border-t bg-secondary/50 mt-20">
      <div className="container mx-auto px-4 py-12 lg:px-13">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-display text-lg font-bold mb-3">SHOPBAZZAR</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Curated essentials for the modern wardrobe. Quality materials,
              timeless design.
            </p>
          </div>
        ...
        <div className="border-t mt-8 pt-6 text-center text-xs text-muted-foreground">
          © 2025 ShopBazzar. All rights reserved.
        </div>
      </div>
    </footer>
  );
