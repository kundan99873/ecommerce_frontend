...
const CategoryNav = () => {
  ...
  return (
    <section className="container mx-auto px-2 py-8 sm:px-4">
      <div className="relative overflow-hidden rounded-xl sm:rounded-[1.5rem] border border-border/50 bg-linear-to-br from-background via-background to-muted/20 p-3 sm:p-6 md:rounded-[2.5rem] md:p-8 lg:p-10">
        ...
        >
          ...
          >
            <div className="max-w-2xl flex-1">
              ...
              <h2 className="text-lg sm:text-2xl md:text-3xl font-bold font-display leading-tight">
                Shop by Category
              </h2>
              ...
              {mobileCategories.map((cat, i) => (
                ...
                >
                  <Link
                    ...
                    className="group relative block aspect-square overflow-hidden rounded-lg sm:rounded-3xl border border-border/50 bg-linear-to-br from-card to-card/80 shadow-sm hover:shadow-md transition-all duration-300 active:scale-95"
                  >
                    <img
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-2 sm:p-2.5">
                      <div className="flex items-end justify-between gap-2 sm:gap-3">
                        ...
                        <div className="flex h-6 w-6 sm:h-7 sm:w-7 shrink-0 items-center justify-center rounded-full bg-white/10 text-primary-foreground backdrop-blur-md transition-all duration-300 group-hover:bg-white/20 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
          ...
          <div className="mt-6 hidden gap-3 md:mt-7 md:grid md:gap-4 lg:gap-5 lg:grid-cols-[1.2fr_1fr]">
            ...
            >
              <Link
                ...
                className="group relative flex min-h-72 md:min-h-80 lg:min-h-96 overflow-hidden rounded-2xl md:rounded-3xl bg-linear-to-br from-muted to-muted/50 shadow-lg hover:shadow-xl transition-all duration-500"
              >
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-linear-to-t from-foreground/85 via-foreground/35 to-transparent" />
                ...
                <div className="relative mt-auto w-full p-5 md:p-7 lg:p-8">
                  <div className="flex items-end justify-between gap-4">
                    ...
                    <div className="hidden h-14 w-14 lg:h-16 lg:w-16 shrink-0 items-center justify-center rounded-full border border-white/20 bg-white/10 text-primary-foreground backdrop-blur-md lg:flex transition-all duration-300 group-hover:bg-white/20 group-hover:scale-110">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 lg:gap-5 auto-rows-fr">
              {gridCategories.map((cat, i) => (
                ...
                >
                  <Link
                    to={`/products?category=${cat.slug}`}
                    className="group relative block h-full overflow-hidden rounded-xl sm:rounded-2xl border border-border/50 bg-linear-to-br from-card/80 to-card/40 hover:border-border/70 shadow-sm hover:shadow-md transition-all duration-300 active:scale-95"
                  >
                    <img
                      src={getCategoryImage(cat)}
                      alt={cat.name}
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4">
                      <div className="flex items-end justify-between gap-2 sm:gap-3">
                        ...
                        <div className="flex h-7 w-7 sm:h-8 sm:w-8 shrink-0 items-center justify-center rounded-lg sm:rounded-full bg-white/15 text-primary-foreground backdrop-blur-sm transition-all duration-300 group-hover:bg-white/25 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
