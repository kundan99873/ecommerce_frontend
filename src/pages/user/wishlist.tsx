...
const Wishlist = () => {
  const { items, removeItem, moveLoading, removeLoading } = useWishlist();
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-2 mt-3">
                    <Button
                      ...
                      onClick={() => {
                        addItem(product.variants[0].sku);
                        removeItem(product.variants[0].sku);
                      }}
                      disabled={
                        moveLoading === product.variants[0].sku ||
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="text-xs"
                      onClick={() => removeItem(product.variants[0].sku)}
                      disabled={removeLoading === product.variants[0].sku}
                    >
                      {removeLoading === product.variants[0].sku ? (
                        <Loader2 className="h-3 w-3 animate-spin" />
                      ) : (
                        "Remove"
                      )}
