...
const Profile = () => {
  ...
  const handleLogout = async () => {
    ...
    if (response.success) {
      ...
      toast({ title: "Logout failed", description: response.message || "An error occurred while logging out." });
    }
  };
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Member since {dayjs(user.created_at).format("Do MMM YYYY")}
              </p>
            </div>
            <Button
              variant="outline"
            ...
            >
              {logoutLoading ? <Loader2 className="h-4 w-4 animate-spin mr-1"/> :<LogOut className="h-4 w-4 mr-1" />} Sign Out
            </Button>
          </div>
              ...
              <div className="bg-card border rounded-lg p-6 space-y-4">
                ...
                {editingProfile ? (
                  <div className="grid gap-4">
                    ...
                    <Button onClick={handleProfileSave} className="w-fit">
                      Save Changes
                    </Button>
                  </div>
                ) : (
